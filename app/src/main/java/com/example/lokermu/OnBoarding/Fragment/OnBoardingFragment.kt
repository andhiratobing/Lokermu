package com.example.lokermu.OnBoarding.Fragment
...
class OnBoardingFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val rootLayout: View = inflater.inflate(R.layout.fragment_on_boarding, container, false)
    ...
    companion object {
        ...
        fun newInstance(
            title: String?,
            description: String,
            imageResource: Int): OnBoardingFragment {
